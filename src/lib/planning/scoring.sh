...
# penalizes long or unsafe plans and encodes rationale strings so operators can
# trace why a candidate won. The resulting scorecard drives selection in
# planner.sh before execution begins.
#
# Usage:
