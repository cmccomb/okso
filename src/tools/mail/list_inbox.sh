...
#
# List recent messages from the Apple Mail inbox.
#
# Usage:
#   source "${BASH_SOURCE[0]%/mail/list_inbox.sh}/mail/list_inbox.sh"
#
...
source "${BASH_SOURCE[0]%/tools/mail/list_inbox.sh}/lib/logging.sh"
...
on run argv
        ...
        tell application "Mail"
                ...
                repeat with msg in items 1 thru upperBound of inboxMessages
